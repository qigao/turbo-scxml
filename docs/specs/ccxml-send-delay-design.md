...
result. Arbitrary ECMAScript delay expressions and inline content remain
deferred. Subsequent send-identifier/cancel and bounded namelist slices are
documented in `docs/specs/ccxml-send-cancel-design.md` and
