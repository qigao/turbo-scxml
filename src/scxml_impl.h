...
struct scxml_session_impl {
    ...
    scxml_expr_system_values system_values;
    scxml_event_io_adapter_v1 event_io;
    scxml_event_io_adapter_v2 event_io_v2;
    scxml_event_io_adapter_v3 event_io_v3;
    void *adapter_user;
    ...
    scxml_invoke_adapter_v1 invoke;
    scxml_invoke_adapter_v2 invoke_v2;
    scxml_invoke_adapter_v3 invoke_v3;
    void *invoke_user;
    ...
    scxml_payload_entry_v3 *payload_scratch_v3;
